...
class Light_sensor():
    ...
    def read_u8(self, reg):
        return self.i2c.readfrom_mem(OTOS_ADDR, reg, 1)[0]


    def write_u8(self, reg, value):
        self.i2c.writeto_mem(OTOS_ADDR, reg, bytes([value & 0xFF]))
    ...
    def read_pose_raw(self):
        data = self.i2c.readfrom_mem(OTOS_ADDR, REG_POS_XL, 6)
    ...
    def calibrate_imu(self):
        try:
            ...
            self.write_u8(REG_IMU_CALIB, 255)
            time.sleep_ms(800)
